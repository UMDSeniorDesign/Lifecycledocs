...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="Requirement | Section">
        ...
        <p>
            <font size="4">
                ...
                <xsl:apply-templates select="Para[@isNewest = 'true']">
                    <xsl:with-param name="offset" select="$sizeOffset"/>
    ...
    <xsl:template match="Para">
        ...
        <xsl:text>&#160;&#160;&#160;&#160;&#160; &#160;&#160;&#160;&#160;&#160;</xsl:text>
        <xsl:if test="$offset &lt; 6">
            <xsl:text>&#160;&#160;&#160;&#160;&#160;</xsl:text>
        </xsl:if>
        <xsl:if test="$offset &lt; 5">
            <xsl:text>&#160;&#160;&#160;&#160;&#160;</xsl:text>
        </xsl:if>
        <xsl:if test="$offset &lt; 4">
            <xsl:text>&#160;&#160;&#160;&#160;&#160;</xsl:text>
        </xsl:if>
        <xsl:value-of select="."/>
        <br/>
